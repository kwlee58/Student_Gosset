...
- long format data frame 을 만드는 또다른 방법은 

```{r}
index.crimtab<-rep(1:nrow(crimtab.3.df), crimtab.3.df[, "Freq"])
index.crimtab[1:10]
crimtab.3.df.long<-crimtab.3.df[index.crimtab, 4:5]
str(crimtab.3.df.long)
crimtab.3.df.long[1:10, ]
```
